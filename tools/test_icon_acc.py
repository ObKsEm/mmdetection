...
from mmdet.datasets.icon import IconDataset
import xml.etree.ElementTree as ET

TABLE_HEAD = ["名称", "样本个数", "tp", "fp", "fn", "precision", "recall"]

test_img_path = "/home/lichengzhi/mmdetection/data/VOCdevkit/icon/JPEGImages"
test_xml_path = "/home/lichengzhi/mmdetection/data/VOCdevkit/icon/Annotations"
test_path = "/home/lichengzhi/mmdetection/data/VOCdevkit/icon/ImageSets/Main/test.txt"
...
def main():
    ...
    model.CLASSES = IconDataset.CLASSES
    ...
    workbook.save("icon_statistics.xlsx")
