...
test_img_path = "/home/lichengzhi/mmdetection/data/VOCdevkit/yuanchu/2020.02.25/JPEGImages"
test_xml_path = "/home/lichengzhi/mmdetection/data/VOCdevkit/yuanchu/2020.02.25/Annotations"
test_path = "/home/lichengzhi/mmdetection/data/VOCdevkit/yuanchu/2020.02.25/ImageSets/Main/test.txt"
...
def main():
    ...
    if os.path.exists("yc_statistics.xlsx"):
        os.remove("yc_statistics.xlsx")
    workbook = openpyxl.Workbook("yc_statistics.xlsx")
    ...
    workbook.save("yc_statistics.xlsx")
