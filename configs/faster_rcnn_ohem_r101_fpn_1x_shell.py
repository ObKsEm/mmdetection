...
# dataset settings
dataset_type = 'RGCocoDataset'
data_root = 'data/coco/shell/2019.11.19/'
img_norm_cfg = dict(
...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file=os.path.join(data_root, 'annotations/instances_test.json'),
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_ohem_r101_fpn_1x_shell_12.21'
load_from = None
resume_from = None
workflow = [('train', 1)]
